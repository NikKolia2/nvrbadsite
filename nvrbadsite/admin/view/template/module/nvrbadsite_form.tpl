          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><input type="text" name="nvrbadsite_description[<?php echo $language['language_id']; ?>][url]" maxlength="255" size="100" value="<?php echo isset($nvrbadsite_description[$language['language_id']]) ? $nvrbadsite_description[$language['language_id']]['url'] : ''; ?>" />
                    <?php if (isset($error_site_url[$language['language_id']])) { ?>
                            <span class="error"><?php echo $error_site_url[$language['language_id']]; ?></span>
                  <?php } ?>
                </td>
              </tr>
              <tr>
                <td><?php echo $entry_description; ?></td>
                <td><textarea name="nvrbadsite_description[<?php echo $language['language_id']; ?>][description]" cols="100" rows="2"><?php echo isset($nvrbadsite_description[$language['language_id']]) ? $nvrbadsite_description[$language['language_id']]['description'] : ''; ?></textarea>
